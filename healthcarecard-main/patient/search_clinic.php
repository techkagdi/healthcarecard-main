  ...
  <section class="home-section">
    ...
    <div class="wrap-login100">
                ...
                <div class="login100-form-title" style="font-size:22px;">
                     	...
                     	<input class="input100" type="text" name="specialization"
						id="select_specialization" placeholder="Specialization" ><!--
						<datalist id="select_specialization_name">
                ...
                <option>dentist</option>
					...
					<div class="container-login100-form-btn">
						...
						<button class="login100-form-btn" name="upload" id="upload">Search
                      </button> 
					</div>
</div></div></div>
...
$sql = "SELECT * FROM master_doctor_table WHERE dr_special='{$special}'";
